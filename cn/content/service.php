...
<h2><a href="guide.php?p=service&c=term" class="link-id-0 active">服务标准</a></h2></li>
...
<li <?php if(isset($_GET['c']) && $_GET['c']=='polishing'){ echo 'class="crr"';} ?>><h2><a href="guide.php?p=service&c=polishing" class="link-id-1">何谓抛光服务？</a></h2></li>

<li <?php if(isset($_GET['c']) && $_GET['c']=='resize'){ echo 'class="crr"';} ?>><h2><a href="guide.php?p=service&c=resize" class="link-id-2">何谓尺寸修改服务？</a></h2></li>
<li <?php if(isset($_GET['c']) && $_GET['c']=='repair'){ echo 'class="crr"';} ?>><h2><a href="guide.php?p=service&c=repair" class="link-id-3">何谓修复服务？</a></h2></li>
<li <?php if(isset($_GET['c']) && $_GET['c']=='pairing'){ echo 'class="crr"';} ?>><h2><a href="guide.php?p=service&c=pairing">何谓重制/配对服务？</a></h2></li>
<li <?php if(isset($_GET['c']) && $_GET['c']=='graving'){ echo 'class="crr"';} ?>><h2><a href="guide.php?p=service&c=graving" class="link-id-5">何谓刻字服务？</a></h2></li>
<li <?php if(isset($_GET['c']) && $_GET['c']=='facelift'){ echo 'class="crr"';} ?>><h2><a href="guide.php?p=service&c=facelift">何谓改款服务？</a></h2></li>
</ul>
</div>
