...
<td style="width:80px;" align="center"><img width="12" src="../images/site_elements/arrow-down.png" /><button type="button" class="sortbtn" title="点击排序" onclick="sorting('symm')">价格</button></td>
