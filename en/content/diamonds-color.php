...
<td align="center" style="width:42px;"><img class="iconarrow" width="8" src="<?php echo $imgsrc; ?>" /><button type="button" class="sortbtn" title="点击排序" onclick="sorting('shape')">Shape</button></td>
<td align="center"><img class="iconarrow" width="8" src="<?php echo $imgsrc; ?>" /><button type="button" class="sortbtn" title="点击排序" onclick="sorting('weight')">Carat</button></td>
<td align="center" style="width:100px;">Color</td>
<td align="center"><img class="iconarrow" width="8" src="<?php echo $imgsrc; ?>" /><button type="button" class="sortbtn" title="点击排序" onclick="sorting('clarity')">Clarity</button></td>
<td align="center" style="width:32px;">Certificate</td>
<td align="center" style="width:32px;">Cut</td>
<td align="center" style="width:32px;">Polish</td>
<td align="center" style="width:42px;">Symmetry</td>
<td align="center" style="width:112px;"><img class="iconarrow" width="8" src="<?php echo $imgsrc; ?>" /><button type="button" class="sortbtn" title="click to sort" onclick="sorting('price')">Price(USD)</button></td>
...
<td class="seedetail" align="center" title="open"><span style="display:inline-block;width:28px; text-align:center; white-space:nowrap;">details</span></td>
</tr>
...
Location: <?php echo $row['country']; ?>
 &nbsp; &nbsp; 
Certificate No.: <?php echo $row['certificate_number']; ?>
 &nbsp; &nbsp; 
<?php
if(trim($row["grading_lab"])=='HRD'){
?>
<a class="certi_linker" target="_blank" href="http://www.hrdantwerplink.be/index.php?record_number=<?php echo $row['certificate_number']; ?>&weight=<?php echo $row['carat']; ?>&L=">view the certificate:</a>
<?php
}else if(trim($row["grading_lab"])=='GIA'){
?>
<a class="certi_linker" target="_blank" href="http://www.gia.edu/cs/Satellite?pagename=GST%2FDispatcher&childpagename=GIA%2FPage%2FReportCheck&c=Page&cid=1355954554547&reportno=<?php echo $row['certificate_number']; ?>">view the certificate:</a>
<?php
}else if(trim($row["grading_lab"])=='IGI'){
?>
<a class="certi_linker" target="_blank" href="http://www.igiworldwide.com/igi/verify.php?r=<?php echo $row['certificate_number']; ?>">view the certificate:</a>
<?php
}
?>
</p>
...
<?php		
		...
		if(count($picsinfolder)){
			?>
            <div class="thumbsbox">
            <p style="margin:0 0 0 10px; font-size:12px; position:relative; top:-3px;">click to amplify</p>
            <?php
			$c=0;		
