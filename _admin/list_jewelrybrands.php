...
<?php
$sql="SELECT * FROM jewelry_brands ORDER BY id DESC";
$ooh=$conn->query($sql);
?>
<table>

<tr>
<td width="90" align="center" style="font-size:14px; background-color:#CC6699; color:#FFF;">品牌(英文)</td>
<td width="220" align="center" style="font-size:14px; background-color:#CC6699; color:#FFF;">品牌(中文)</td>
...
<td align="center"><?php echo $row['brand_en']; ?></td>
<td align="center"><?php echo $row['brand_cn']; ?></td>


<td align="center">

<button type="button" onclick="delete_jb('<?php echo $row['id']; ?>')">删除</button>
</td>
</tr>
<?php
}
...
<a href="new_jewelry_brand.php" style="display:inline-block; padding:8px 35px; border-style:outset; border-width:1px; background-color:#CC6699; color: #FFF; text-decoration:none; border-radius:6px;">+添加首饰品牌</a>
</p>
