...
if(isset($_POST['content_en']) && isset($_POST['content_ch'])){
	...
	$sql_insert='INSERT INTO usefulinfo (category, title_en, title_ch, text_en, text_ch, main_image_ch, main_image_en) VALUES (:category, :title_en, :title_ch, :text_en, :text_ch, :main_image_ch, :main_image_en)';
	...
	$stmt->bindParam(':main_image_ch', $main_image_ch, PDO::PARAM_STR);
	$stmt->bindParam(':main_image_en', $main_image_en, PDO::PARAM_STR);
...
<option value="promotion-diamond">特惠信息(裸钻)</option>
<option value="promotion-jewelry">特惠信息(首饰)</option>
<option value="knowledge">钻石知识</option>
<!--
<option value="industry">产业新闻</option>
-->
<option value="publicmedia">媒体报道</option>
</select>
  </p>
  ...
  <p>
    <button type="button" id="submit_article" style="font-size:18px; font-weight:bold; padding:12px 50px; background-color:#CC6699; color:#FFF; border-width:1px;"> 提交文章 </button>
  </p>
  <br /><br /><br /><br /><br />
</form>
